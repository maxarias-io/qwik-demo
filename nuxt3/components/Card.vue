...
<div class="flex flex-col">
      <div class="flex gap-2 items-center">
        <h1
          :class="[
            { 'line-through text-gray-200': hidden, 'text-gray-900': !hidden },
            'whitespace-nowrap',
          ]"
        >
          {{title}}
        ...
        <a
          :class="[
            { 'line-through text-gray-200': hidden, 'text-gray-400': !hidden },
      ...
      <ul class="flex flex-row text-gray-400 font-light text-xs gap-3">
        <li :class="[{ 'line-through text-gray-200': hidden }, 'flex gap-1']">
        ...
        <li>
          <button
            :class="[{ 'text-gray-900': hidden }, 'hover:underline']"
            type="button"
            @click="hidden = !hidden;"
          >
            {{!hidden ? "hide" : "show"}}
        ...
        <li :class="{ 'line-through text-gray-200': hidden }">
